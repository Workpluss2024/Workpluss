    ...
    return (
        <TouchableOpacity
            ...
            style={[props?.dflt && { height: 56 }, {
                ...
                alignItems: 'center',
                backgroundColor: props?.backgroundColor ? props.backgroundColor : ( isFocused ? theme.SecondaryBackground : theme.Primary ),
            ...
            <CustomText
                ...
                color={props?.textColor ? props?.textColor : theme.Alternate}
            />
        </TouchableOpacity>
    );
}
