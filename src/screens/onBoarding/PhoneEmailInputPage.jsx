                ...
                <ScrollView style={commonStyles.scrollViewContainer}>
                    ...
                    <View style={[commonStyles.contentContainer, { minHeight: windowHeight - 65 }]}>
                        ...
                        <View style={styles.container}>
                            <View>
                                <CustomText title="E-mail" fontFamily={FontDirectory.PoppinsMedium} fontSize={14} color={theme.Primary} />
                                <View style={[styles.inputOuterContainer, { backgroundColor: theme.SecondaryBackground }]}>
                                    <TextInput
                                        ...
                                        style={styles.input}
                                    />
                                    <TouchableOpacity mode="contained" style={[styles.button, { backgroundColor: theme.Primary }]}>
                            ...
                            <CustomText title="Please ensure that you have used the email address   associated with your Aadhaar card."
                                fontSize={10}
                                color={theme.Primary}
                                style={{
                                    textAlign: 'center',
                        ...
                        <SkipForNowComponent style={{ flex: 1 }} />
                    </View>
                </ScrollView>
